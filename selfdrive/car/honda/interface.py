...
class CarInterface(CarInterfaceBase):
  ...
  def _get_params(ret, candidate, fingerprint, car_fw, experimental_long, docs):
    ...
    # base value applicable to most models
    ret.minSteerEnableSpeed, ret.minSteerDisableSpeed = 12. * CV.MPH_TO_MS, 12. * CV.MPH_TO_MS
    if candidate == CAR.CIVIC:
      ...
      if eps_modified:
        ...
        ret.minSteerEnableSpeed, ret.minSteerDisableSpeed = 0., 0.
      else:
      ...
      # TODO: 2017-2018 has a minSteerSpeed of 12mph. 2019+ has a minSteerSpeed of 2mph.
      # Setting it to 12 would break steering down to 2 mph and vice versa.
      ret.minSteerEnableSpeed, ret.minSteerDisableSpeed = 2. * CV.MPH_TO_MS, 2. * CV.MPH_TO_MS
      ...
      if eps_modified:
        ...
        ret.minSteerEnableSpeed, ret.minSteerDisableSpeed = 3. * CV.MPH_TO_MS, 3. * CV.MPH_TO_MS
      ...
      ret.lateralTuning.pid.kpV, ret.lateralTuning.pid.kiV = [[0.8], [0.24]]
      ret.minSteerEnableSpeed, ret.minSteerDisableSpeed = 25. * CV.MPH_TO_MS, 25. * CV.MPH_TO_MS
      ...
      ret.tireStiffnessFactor = 0.677
      # ret.minSteerEnableSpeed, ret.minSteerDisableSpeed = 3. * CV.MPH_TO_MS, 3. * CV.MPH_TO_MS
      # Simulate the 2021+ Odyssey
      ret.minSteerEnableSpeed = 46.5 * CV.MPH_TO_MS
      ret.minSteerDisableSpeed = 36.5 * CV.MPH_TO_MS
      ...
      if candidate == CAR.ODYSSEY_CHN:
        ...
        ret.lateralParams.torqueBP, ret.lateralParams.torqueV = [[0, 4096], [0, 4096]]  # TODO: determine if there is a dead zone at the top end
      # TODO: Is this correct for CAR.ODYSSEY_CHN??
      ret.minSteerEnableSpeed, ret.minSteerDisableSpeed = 0., 0.
