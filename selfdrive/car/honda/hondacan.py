...
def create_acc_commands(packer, enabled, accel, gas, idx, stopped, starting, car_fingerprint):
  ...
  # no gas = -30000
  gas_command = gas if enabled and gas > 0 and accel > 0. else -30000
...
def create_ui_commands(packer, pcm_speed, hud, car_fingerprint, is_metric, idx, openpilot_longitudinal_control, stock_hud, cnter):
  commands = []
